...
const MarkerContainer = ({
    ...
    marker: Marker;
    map: MapOptions;
    element: (marker: Marker, map: MapOptions) => React.ReactElement;
}) => {
    ...
    const onMouseLeave = (e: any) => {
        e.stopPropagation();
        marker.callEventCallback("mouseout", e);
    };
...
export class Marker extends ObjectInMap {
    ...
    constructor(
        ...
        this.marker.on("add", (e) => {
            if (!this.map) {
                console.error(
                    "Cannot continue in add callback - Map not attached to marker"
                );
                return;
            }
